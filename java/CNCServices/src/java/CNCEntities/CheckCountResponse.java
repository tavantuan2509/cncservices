 ...
 */
public class CheckCountResponse extends BaseEntity {
    ...
    public CheckCountResponse(Integer code, String msg, String listprovider) {
        this.code = code;
        this.msg = msg;
    ...
    public JSONObject getJsonEntity() {
        ...
        try {
            ...
            Logger.getLogger(CheckCountResponse.class.getName()).log(Level.SEVERE, null, ex);
        }
        return jo;
    }
